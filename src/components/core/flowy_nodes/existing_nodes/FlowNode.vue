<template>
	<div class="panel-wrapper">
		<font-awesome-icon v-if="node.isCloned && render" icon="fa-solid fa-clone" title="Узел - клон" />
...
export default {
	...
	methods: {
		...
		replaceNode(node, e) {
			...
			if ((replaceLeft && nodeTreeIndex === 0) || (!replaceLeft && nodeTreeIndex === nodeTree.length - 1))
				return;
